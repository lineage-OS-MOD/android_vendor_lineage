...
LINEAGE_VERSION := Predator-v$(PREDATOR_VERSION_BASE)-$(shell date +%Y%m%d)-$(LINEAGE_BUILD)-$(PREDATOR_BUILD_TYPE)-$(BUILD_TIME)
LINEAGE_DISPLAY_VERSION := Predator-v$(PREDATOR_VERSION_BASE)-$(LINEAGE_BUILD)-$(PREDATOR_BUILD_TYPE)-$(BUILD_TIME)
...
ifneq ($(PRODUCT_DEFAULT_DEV_CERTIFICATE),build/target/product/security/testkey)
    ifneq ($(LINEAGE_BUILDTYPE), UNOFFICIAL)
        ...
        ifeq ($(LINEAGE_VERSION_MAINTENANCE),0)
            LINEAGE_DISPLAY_VERSION := $(TARGET_VENDOR_RELEASE_BUILD_ID)-$(LINEAGE_BUILD)
        else
            LINEAGE_DISPLAY_VERSION := $(LINEAGE_VERSION_MAINTENANCE)-$(TARGET_VENDOR_RELEASE_BUILD_ID)-$(LINEAGE_BUILD)
        endif
    endif
endif
endif
